...
console.log(formatDate(randomHoliday.date));

// Find the first and last holiday
// const sortedHolidayDates = Object.values(holidays)
//     .map(holiday => holiday.date)
//     .sort((a, b) => a - b)
// const firstHoliday = sortedHolidayDates[0];
// const lastHoliday = sortedHolidayDates[sortedHolidayDates.length - 1];
